...
<div style="margin-bottom: 20px;" class="row">
    <div class="span8">
        <h2 id="applyTitle"><i class="fa fa-user fa-fw"></i> Apply</h2>
    </div>
</div>
<div class="row">
<div class="span12">
<div id="applyStep1">
    <div class="well">
        ...
        <strong>(2) VA in existence minimum of six months (three months for SOAs)</strong> Virtual Airlines are created all the time but many fail to either achieve a critical mass of members or maintain the management commitment for a significant period of time and are quickly abandoned.  A VA that has been in existence for six months or more is likely to have overcome the initial problems that doom many startups.<br /><br />

        <strong>(3) 20+ pilots with VATSIM PIDs listed in an accessible roster (10+ pilots for SOAs)</strong> The presence of at least twenty pilots on a VA’s roster indicates that it has achieved some level of acceptance in the pilot community.  Partner VAs are subject to periodic audits by VATSIM Audit Managers to ensure that they are maintaining the requirements for said status.  To facilitate these audits, VATSIM Pilot Identification numbers must be available to the audit managers on a roster that is publicly accessible on the VA website.  It would be beneficial as well if pilot roster entries were linked to a source such as vataware www.vataware.com or vatstats www.vatstats.net .  A VA claiming to be unable to comply with this requirement must delineate the reason.  Compliance with this requirement may be granted if said VA is able to provide, upon request of an audit manager or VATSIM official, a list with this information.<br /><br />
    ...
    <button id="applyToStep2" class="btn btn-success"><i class="fa fa-check fa-fw"></i> I do meet these requirements and wish to apply as an official <strong>VA Partner</strong></button>
    <br />
    <small style="margin-left: 200px;">or</small>
    <br />
    <button disabled="disabled" id="applyToStep2A" class="btn btn-special"><i class="fa fa-rocket fa-fw"></i> I do not meet these requirements and wish to join the <strong>VA Associate Program</strong></button> <span class="label label-warning">Coming Soon</span>
</div>
<div style="display: none;" id="applyStep2">
   <button style="margin-bottom: 20px;" class="btn btn-default applyBackToStep1Btn"><i class="fa fa-arrow-left fa-fw"></i> Back</button>
    <h4><i class="fa fa-plane fa-fw"></i> VA Partner Program Application</h4>
    <hr/>
...
<div style="display: none;" id="applyStep2A">
    <button style="margin-bottom: 20px;" class="btn btn-default applyBackToStep1Btn"><i class="fa fa-arrow-left fa-fw"></i> Back</button>
    <div style="display:none;" id="applyStep2Success">
        <div class="alert alert-success">
            Congratulations your submission was submitted successfully. You should receive an email with further details. Please now login and upload a banner for your virtual airline.
    ...
    <div style="display: none;" id="applyStep2AErrors"></div>
    <form id="vaAssociateForm" class="form-horizontal">
        <h4><i class="fa fa-rocket fa-fw"></i> VA Associate Program Application</h4>
        <hr />
        <input type="hidden" name="_token" value="{{ csrf_token(); }}">
        <div class="control-group">
            <label class="control-label" for="inputCid">VATSIM CID</label>
        ...
        <div class="control-group">
            <div class="controls">
                <button id="submitAssociateForm" class="btn btn-success">Submit <i class="fa fa-arrow-right fa-fw"></i></button>
            </div>
        </div>
    </form>
</div>
